    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-black border border-white rounded-2xl p-8 max-w-md w-full shadow-[0_0_50px_rgba(255,255,255,0.1)]">
        ...
        <div className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-white uppercase tracking-tight">Deploy Protocol</h2>
          <p className="text-neutral-400 mt-2 text-sm">Create a new smart contract factory for your organization's assets.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-bold text-neutral-500 uppercase tracking-wider mb-2">Protocol Name</label>
            <input 
              type="text" 
              value={name}
